...
public class CropTypeBuilder implements Supplier<CropType> {
  ...
  public final List<CraftingSeedGenerationInfo> toGenerate =
      new ArrayList<CraftingSeedGenerationInfo>();
        ...
        stemModel == null
            ? new CropType(
                ...
                ResourceLocation.fromNamespaceAndPath(
                    MysticalAgricultureAPI.MOD_ID, "block/mystical_resource_crop"))
            : new CropType(id, stemModel);
