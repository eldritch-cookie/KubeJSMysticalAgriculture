...
public class CropTypeBuilder implements Supplier<CropType> {
  ...
  public CropType createCropType(){
    cropType = stemModel == null ? new CropType(id,new ResourceLocation(MysticalAgricultureAPI.MOD_ID, "block/mystical_resource_crop")) : new CropType(id,stemModel);
  ...
  public CropTypeBuilder setStemModel(String stemModel){
    this.stemModel = new ResourceLocation(stemModel);
    return this;
  }
